...
const EventImage = ({ eventData, height, width }) => {
  ...
  return typeof height !== "undefined" ? (
    <span className="relative">
      ...
      ></Image>
      {!coverImage && (
        <p className="text-center text-xs text-ellipsis overflow-hidden absolute top-0 bottom-0 left-0 right-0 h-fit m-auto rotate-[-30deg] whitespace-nowrap text-[rgba(51,51,51,0.5)]">
          {event_title1}
        </p>
      )}
    </span>
