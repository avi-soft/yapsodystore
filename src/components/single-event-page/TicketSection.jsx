  ...
  return !access ? (
    <div className="relative ml-[30px] min-h-[1px] w-[33.33%] pl-[10px] pr-[10px] text-center max-md:w-[100%] max-md:ml-[0px] ">
      <div className="relative mt-[10px] inline-block w-[100%]">
        <div className="mt-[5px] text-center w-[100%] font-lato text-[18px]">
        ...
        <div className="flex flex-col items-center">
          <div className="mt-[-40px] w-[100%]">
            <input
              ...
              className="h-[33px] w-[125px] rounded-[3px] border-[2px] border-solid bg-[#ffffff] text-center shadow-[0px_1px_1px_rgba(0,0,0,0,0.75)] max max-md:w-[95%]"
              required
            ></input>
          </div>
          <div
