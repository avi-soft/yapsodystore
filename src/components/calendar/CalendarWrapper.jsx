  ...
  return (
    <>
      <div className="sm:hidden flex  border-b mb-2 gap-2 w-[100%] ">
        ...
        <div>
          <button onClick={() => document.getElementById('my_modal_5').showModal()}><div tabIndex={0} role="button">
            ...
            <div className="flex justify-center mt-5">
              <form method="dialog">
                <div className="flex flex-row items-center ">
                  ...
                  <button className=" ml-2 bg-transparent text-white items-center">CLOSE</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div className="ml-2">
            <div className="w-full">
              <div className="dropdown">
                ...
                <div
                  tabIndex={0}
                  className="dropdown-content z-[100]"
                >
                  {children}</div></div>
            </div>
          </div>
