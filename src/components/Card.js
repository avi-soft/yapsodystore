            ...
            <div className='bg-white border rounded text-slate-500 border-blue-600'>
                <div className="lg:grid grid-cols-3 gap-4 items-center">
                    ...
                    <div className='text-center text-[12px] text-slate-500 py-5'>
                        {
                            isCodeAvailable && <div className='mb-2'>
                                <input className='transition-all border rounded-lg focus:outline-blue-300 text-center w-[150px] h-[35px]' type="text" name="" id="" placeholder='Enter a code' />

                            </div>

                        }
                        <div>
                            <button class="bg-purple-400 text-lg text-white py-2 px-4 rounded">{isCodeAvailable ? "Get Access" : "Get Ticket"}</button>
                        </div>
