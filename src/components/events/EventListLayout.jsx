...
export default function EventListLayout({
  ...
  return (
    ...
    >
      <Link href={`/event/index/${eventId}/${eventName.replace(/[^\w\s]/g, "").replace(/\s+/g, "-").replace(/-+$/, "")}`} className="relative min-h-[100%] w-[25%] justify-center max-md:w-[100%] max-md:h-[180px] px-[4px] py-[4px]">
        <article className="h-[100%] w-[100%] relative overflow-hidden object-fill">
