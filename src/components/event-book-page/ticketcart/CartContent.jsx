...
const CartContent = ({
  ...
  const tax = selectedTickets && selectedTickets * 0.5;
  const tax3 = selectedTickets && selectedTickets * 1.0;
  const ticketPrice = selectedTickets && selectedTickets * 50 + tax + tax3;

  return (
    <div>
      {typeof seatsTickets !== "undefined" && type === "seats-io" ? (
        <SeatCartContent
            ...
            <div className={` ${styles.buttonContainer}`}>
              ...
              >
                <div className="flex justify-center items-center  w-full">
                  <div className="w-10/12 items-center text-xl">
                    SAVE TO CART
                  </div>
                  <div>
                    <Image
